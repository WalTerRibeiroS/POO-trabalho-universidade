...
class Funcionario:
    ...
    def acessar_menu_de_estoque(self, estoque):
        while True:
            ...
            print("2 - Procurar pisos em estoque")
            ...
            if opcao == 1: # -- cadastrar novo piso no sistema
                self.cadastrar_piso(estoque)
            
            if opcao == 2: # -- procurar piso no sistema
                self.procurar_piso(estoque)
            
            if opcao == 3: # -- listar pisos cadastrados no sistema
                self.listar_piso(estoque)
            
            if opcao == 4: # -- atualizar piso do sistema
                self.atualizar_piso(estoque)
            
            if opcao == 5: # -- deletar piso do sistema
                self.deletar_piso(estoque)
            
            if opcao == 6: # -- registrar SAIDA de piso no sistema
                self.registrar_saida_de_piso_do_estoque(estoque)
            
            if opcao == 7: # -- registrar ENTRADA de piso no sistema
                self.registrar_entrada_de_piso_do_estoque(estoque)
            
            if opcao == 8: # -- sair do menu
                self.sair_do_menu()
                break
            
    def cadastrar_piso(self, estoque): # -- opcao 1
        while True:
            nome = input("\nDigite o nome: ")
    ...
    def procurar_piso(self, estoque): # -- opcao 2
        while True:
    ...
    def listar_piso(self, estoque): # -- opcao 3
            if not estoque:
    ...
    def atualizar_piso(self, estoque): # -- opcao 4
        while True:
    ...
    def deletar_piso(self, estoque): # -- opcao 5
        while True:
    ...
    def registrar_saida_de_piso_do_estoque(self, estoque): # -- opcao 6
        while True:
    ...
    def registrar_entrada_de_piso_do_estoque(self, estoque): # -- opcao 7
        while True:
...
class Administrador(Funcionario):
    ...
    def acessar_menu_de_estoque(self, estoque):
        return super().acessar_menu_de_estoque(estoque)

    def cadastrar_piso(self, estoque):
        return super().cadastrar_piso(estoque)
    
    def procurar_piso(self, estoque):
        return super().procurar_piso(estoque)
    
    def listar_piso(self, estoque):
        return super().listar_piso(estoque)
    
    def atualizar_piso(self, estoque):
        return super().atualizar_piso(estoque)
    
    def deletar_piso(self, estoque):
        return super().deletar_piso(estoque)
    
    def registrar_saida_de_piso_do_estoque(self, estoque):
        return super().registrar_saida_de_piso_do_estoque(estoque)
    
    def registrar_entrada_de_piso_do_estoque(self, estoque):
        return super().registrar_entrada_de_piso_do_estoque(estoque)
    
    def sair_do_menu(self):
        return super().sair_do_menu()
...
class Operador(Funcionario):
    ...
    def cadastrar_piso(self, estoque):
        print("============================================================================")
        print("\noperadores não tem permissão para acessar essa opcão!!!")
        print("opções permitidas: 6, 7 e 8")
